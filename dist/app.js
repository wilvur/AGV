...
function cargarBusquedas(categoriaId) {
    ...
    const categoriaDescripcion = categorias.filter(categoria => categoria.id === categoriaId.toString()).map(categoria => {return categoria.descripcion});
...
<path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm.707-10.293a1 1 0 00-1.414-1.414l-3 3a1 1 0 000 1.414l3 3a1 1 0 001.414-1.414L9.414 11H13a1 1 0 100-2H9.414l1.293-1.293z" clip-rule="evenodd" />
 ...
 <article id="busquedaD" class="bg-white w-full md:w-1/2 rounded-lg shadow-lg mx-auto p-3 mb-12 ">                  
    ...
    <div class="text-sm my-3">
     ...
     <div class="flex shadow-lg rounded-full ring-2 p-1 text-center justify-center my-2 hover:bg-azul_Agv1 hover:text-white">             
        <a href="mailto:agvconsultorarrhh@gmail.com <agvconsultorarrhh@gmail.com>;?&subject=Postulacion-ref:${aviso.id}]&:cc=&bcc=&body=http://www.agv-recursoshumanos.com.ar/">
        Postularse</a> 
     </div>

    <div class="flex justify-between ">
    <div class="text-xs text-gray-500">
        <div><span class="font-bold">Publicado:</span> ${aviso.fechaAlta}</div>
    </div>
    <!-- iconos -->
    <div class="flex  cursor-pointer text-xs relative items-center ">
        ...
        <div class="bg-white absolute flex justify-between rounded-lg shadow-lg top-6 right-0 w-40 h-16 p-4">
            ...
            <a href="whatsapp://send?text=http://www.agv-recursoshumanos.com.ar/" data-action="share/whatsapp/share" target="_blank"> <img src="./img/whatsapp.png" class="w-8 " alt=""></a>
...
function Armarcard(titulo, intro, activo, descripcion, categoriaDesc, zona, fechaAlta, id) { 
    ...
    <div class="text-xs text-gray-500">    
            <span class="font-bold">Publicado:</span> ${fechaAlta}
    </div>
   </div>
</article>
`;
